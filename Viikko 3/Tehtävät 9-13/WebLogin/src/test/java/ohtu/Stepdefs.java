...
public class Stepdefs {
    ...
    public void a_non_valid_username_and_password_and_matching_password_confirmation_are_entered(String username, String password) throws Throwable {
        createWith(username, password, password);
    }
    ...
    public void a_valid_username_and_password_and_non_matching_password_confirmation_are_entered(String username, String password) throws Throwable {
        createWith(username, password, password+"WAT");
    }
